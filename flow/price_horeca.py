class init(Flowable):	
	def __init__(self,price_rub,price_kop,items=1,scale=1,x0=0,y0=0):
		...
		self.rub_width = utils_text.text_size_check_width(self.price_rub,self.rub_font,self.rub_font_size)

		self.kop_font = 'HelveticaNeue-BoldCr'
		self.kop_font_size = 15*scale
		self.kop_width = utils_text.text_size_check_width(self.price_kop,self.kop_font,self.kop_font_size)
		...
		self.items_width = utils_text.text_size_check_width(self.items,self.items_font,self.items_font_size)
