...
def init():
	...
	pdfmetrics.registerFont(TTFont('HelveticaNeue_LT_CYR_67_MedCn.ttf', os.path.join(os.getcwd(),'storage/HelveticaNeue LT CYR 67 MedCn.ttf')))
	pdfmetrics.registerFont(TTFont('HelveticaNeue-BoldCr', os.path.join(os.getcwd(),'storage/HelveticaNeueLTCYR-Bd.ttf')))
	pdfmetrics.registerFont(TTFont('HelveticaNeue-BoldCd', os.path.join(os.getcwd(),'storage/HelveticaNeueLTPro-BdCn.ttf')))
